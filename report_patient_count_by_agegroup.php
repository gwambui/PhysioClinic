...
$upper = empty($_POST['upper']) ? 18: ($_POST['upper']);
$lower = empty($_POST['lower']) ?  18: ($_POST['lower']);

$rows = $rba->GetPatientsGroupedByAge($lower, $upper );
?>
    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                ...
                <? if (in_array($_SESSION['user']['Type_ID'], array(AuthENUMS::ADMIN, AuthENUMS::SUPERVISOR, AuthENUMS::ADMIN))) { ?>
                    <li class="active"><a href="report_patient_count_by_agegroup.php"><i class='fa fa-file-text-o'></i>&nbsp;Patient Count By Age Group</a></li><? } ?>
            </ul>
        </div>
        ...
        <div class="col-sm-6 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div id="main" class="container"
                ...
                <h2>View Patient Information and Count Grouped by Age</h2>
                <p><i>Note: Set X Lower age limit and Y Upper age limit </i></p>

                <form  method='post' action="report_patient_count_by_agegroup.php">
                    <div class="row">
                        <div class="col-sm-3 col-md-3"><label for="from">Lower Age Limit</label>
                            <input type="number"  min="18"  name="lower" class="form-control" id="lower"
                                   value="<? echo $lower; ?>"></div>
                        <div class="col-sm-3 col-md-3"><label for="from">Upper Age limit</label>
                            <input type="number"  min="18" name="upper" class="form-control" id="upper"
                                   value="<? echo $upper; ?>"></div>
