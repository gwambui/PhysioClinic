...
$rba = new reportingBA();
$rows = $rba->GetPatientsWithoutAppointments();
?>
        ...
        <div class="row">
            <div class="col-sm-3 col-md-2 sidebar">
                <ul class="nav nav-sidebar">
                    ...
                    <? if (in_array($_SESSION['user']['Type_ID'], array(AuthENUMS::ADMIN, AuthENUMS::SUPERVISOR, AuthENUMS::DOCTOR))) { ?>
                        <li class="active"><a href="report_patients_without_appointment.php"><i class='fa fa-file-text-o'></i>&nbsp;Patients With Prescription but no Appointment</a></li><? } ?>
            ...
            <div class="col-sm-6 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                <div id="main" class="container"
                    ...
                    <h2>Patients with Active Prescriptions But No Future Appointments</h2>
                    <p><i>Doctors should change prescription status to complete or invite patients for new appointment.</i></p>
