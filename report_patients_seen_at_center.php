...
$clinicID = empty($_POST['centerID'])  ? "Alpha" :$_POST['centerID'] ;
    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                ...
                <? if (in_array($_SESSION['user']['Type_ID'], array(AuthENUMS::ADMIN, AuthENUMS::SUPERVISOR, AuthENUMS::ADMIN))) { ?>
                    <li class="active"><a href="report_patients_seen_at_center.php"><i class='fa fa-file-text-o'></i>&nbsp;Patient Seen At Center</a></li><? } ?>
        ...
        <div class="col-sm-6 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div id="main" class="container"
                ...
                <form class="form-horizontal" role="form" method="post" action="report_patients_seen_at_center.php">
                    <h2>Patient Seen at a Clinic- Detailed Information Report</h2>
                    ...
                    <form action="<? echo $_SERVER['PHP_SELF']; ?>" method='post'>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12"><input type="submit" value="Select" class="btn btn-primary">
                ...
                <?
                $clinicID = $_POST['centerID'];

                $rows = $rba->GetPatientsSeenAtCenter($clinicID);
